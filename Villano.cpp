...
Villano::Villano(unsigned short wSprite_, unsigned short hSprite_,
                 short x_sprite_, short y_sprite_, short posx_, short posy_,
                 const QString &direccion_, bool salto_, short vida_, unsigned short velocidadX_,
                 unsigned short wPersonaje_, unsigned short hPersonaje_, int danio_)
    : Personaje(wSprite_, hSprite_,
                x_sprite_, y_sprite_, posx_,
                posy_, direccion_, salto_, vida_, velocidadX_,
                wPersonaje_, hPersonaje_) {
    danio=danio_;
}
